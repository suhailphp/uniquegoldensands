...
r("audio")}function o(a){return a.split("http://e-merald.com/").slice(0,-1).join("http://e-merald.com/")+"/"}function t(a,b,c){return c||B[a][b.split(".").slice(-1)[0]]||d[a]}function k(a,b){var c=a.getAttribute(b);return c==!0||typeof c=="string"}function m(a){return a.substr(0,1)=="/"?C+a:a.substr(0,1)=="."||!a.match(/^\s*\w+:\/\//)?v+a:a}function l(a,b,c){var d=a.getAttribute(b);if(d)return d+"px";if(a.currentStyle)a=a.currentStyle[b];else if(j.getComputedStyle)a=i.defaultView.getComputedStyle(a,null).getPropertyValue(b);else return c;
